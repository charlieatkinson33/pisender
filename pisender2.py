...
def discover_pi_ip():
    try:
        ...
        print("[Sender] Ping to Pi failed.")
        return None
...
def send_data():
    if not PI_IP:
        messagebox.showerror("Connection Error", "Cannot reach Pi at 192.168.4.1. Please check your network connection.")
        return
    try:
        ...
        messagebox.showerror("Send Error", f"Could not send data to Pi: {e}")
